#include "celestialMathematics/StarGeneration.h"

#include <cmath>

float StarGeneration::calculateLuminosityByTemperature(float temperature) {
  /*
  ...
  if( temperature > 5500.0f ) {
    ...
    float temperatureRanged = (temperature - 3000.0f) / (5500.f - 3000.0f);
    float trigonometricinput = temperatureRanged * (M_PI/2.0f - 0.25f); // found 0.25 emperical with wolfram alpha
